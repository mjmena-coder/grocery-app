...
def parse_ingredient_line(line: str) -> dict:
    ...
    """
    # TODO: Not needed after moving to VLM (was relevant in apple vision approach).
    ...
    # Values that can be pulled from parsed variable:
    #   - name
    #   - size
    #   - amount
    #   - preparation
    #   - comment
    #   - purpose
    #   - foundation foods (if keyword arg used)
    ...
    # TODO: remove, not needed after moving to VLM (was relevant in apple vision approach).
    ...
    # TODO: Multiple amounts parsed when there's an or in the ingredient each with quantities. Decide how to fix.
    #       This case: multiple amount objects. Other cases: One amount object with range. Prev both have triggered manual check alerts. 
